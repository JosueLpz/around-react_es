  ...
  return (
    <>
      <fieldset className={`popup ${props.name}`}>
        <form className={`form__container popup__${props.name}`} name={props.name} noValidate onSubmit={props.onSubmit}>
          <button onClick={props.handleClose} className="form__container-closed root__buttom-closed-active popup__closed">
